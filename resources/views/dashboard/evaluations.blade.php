...
<x-dashboard-layout>
    <x-slot:title>Evaluations</x-slot:title>

    <section>
        <div class="mb-4 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
            <div>
                <h2 class="text-2xl font-semibold">Recent evaluations</h2>
                <p class="text-sm text-base-content/70">Review evaluations manage shares and submissions.</p>
            </div>

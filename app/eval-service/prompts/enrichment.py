"""LLM prompt templates for resume enrichment analyze."""
...
Identify experience and project entries in top-to-bottom reading order. Assign item IDs by position: exp_0 = first experience/employment entry, exp_1 = second, proj_0 = first project entry, proj_1 = second, and so on.

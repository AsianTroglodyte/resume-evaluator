...
from llm import complete_json, get_llm_config, get_model_name
from prompts import PARSE_RESUME_PROMPT, RESUME_SCHEMA_EXAMPLE
from schemas import ResumeData, normalize_resume_data
...
async def parse_resume_to_json(markdown_text: str) -> dict[str, Any]:
    ...
    validated = ResumeData.model_validate(normalize_resume_data(result))
